  ...
  return (
    <div data-role="Header" className={`header-header ${props.rootClassName} `}>
      ...
      <Link to="/meowsteal" className="header-navlink1">
        <h1 className="header-heading2 textSM">{props.heading13}</h1>
      </Link>
      ...
      <div className="header-container1">
        <a
          href="https://tinyurl.com/meowstudios-yt"
          target="_blank"
          rel="noreferrer noopener"
        ...
        <a
          href="https://github.com/meow-studios"
          target="_blank"
          rel="noreferrer noopener"
...
Header.defaultProps = {
  rootClassName: '',
  image_src: '/playground_assets/image-removebg-preview-200h.png',
  heading11: 'NOTUS PRO',
  image_alt: 'image',
  heading13: 'MeowSteal SMP',
  heading1: 'Meow Studios',
  heading12: 'MeowSMP',
}
